...
CREATE TABLE `restaurant_details` (
  ...
  `totalNumberOfTables` int NOT NULL,
  `bookingOpenDate` date NOT NULL,
  `bookingCloseDate` date NOT NULL,
  `eachTableCapacity` int NOT NULL,
...
INSERT INTO `restaurant_details` VALUES ('Green Land Restaurant',30,'2023-12-16','2024-01-15',4),('Hari Bhavanam',20,'2023-12-16','2024-01-15',4),('SS Hydrebad Briyani',50,'2023-12-16','2024-01-15',4);
